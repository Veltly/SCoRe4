...
public:
  ...
  static const char *CVSHeaderVers() {
    return "G4ScreenedNuclearRecoil.hh,v 1.24 2008/05/01 19:58:59 marcus Exp "
           "GEANT4 tag ";
  }
...
public:
  ...
  SelectRandomUnweightedTarget(const G4MaterialCutsCouple *couple);
...
class G4ScreenedCoulombClassicalKinematics
    : public G4ScreenedCoulombCrossSectionInfo,
...
public:
  ...
  G4bool DoScreeningComputation(class G4ScreenedNuclearRecoil *master,
                                const G4ScreeningTables *screen, G4double eps,
                                G4double beta);
...
public:
  ...
  G4ScreenedNuclearRecoil(const G4String &processName = "ScreenedElastic",
                          ...
                          G4double RecoilCutoff = 1.0 * eV,
                          G4double PhysicsCutoff = 1.0 * eV);
  ...
  virtual G4bool
  CheckNuclearCollision(G4double A, G4double A1,
...
class G4NativeScreenedCoulombCrossSection
    : public G4ScreenedCoulombCrossSection {
public:
  ...
  typedef G4_c2_function &(*ScreeningFunc)(G4int z1, G4int z2, size_t nPoints,
                                           G4double rMax, G4double *au);
...
G4_c2_function &ZBLScreening(G4int z1, G4int z2, size_t npoints, G4double rMax,
                             G4double *auval);

G4_c2_function &MoliereScreening(G4int z1, G4int z2, size_t npoints,
                                 G4double rMax, G4double *auval);

G4_c2_function &LJScreening(G4int z1, G4int z2, size_t npoints, G4double rMax,
                            G4double *auval);
